...
for (i in 1:30)
epsilon[i,(41-i)] = cov[i,]*eta;
epsilon[1,1:39] = epsilonrest[1,];
for (i in 2:30) {
  epsilon[i,1:(40-i)] = epsilonrest[i,1:(40-i)];
  epsilon[i,(42-i):40] = epsilonrest[i,(41-i):39];
}
for (i in 1:40)
...
model {
for (i in 1:30)
N[i,1:(41-i)] ~ poisson(mu[i,1:(41-i)]);
